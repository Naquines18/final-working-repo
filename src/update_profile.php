...
if(isset($_POST['id']) AND isset($_POST['address']) AND isset($_POST['mobile']) AND isset($_POST['birthday'])){
    ...
    $mobile     = ucfirst(mysqli_real_escape_string($conn, $_POST["mobile"]));
...
if(isset($_POST['add_id']) AND isset($_POST['add_address']) AND isset($_POST['add_mobile']) AND isset($_POST['add_birthday'])){
    ...
    //sanitize inputs
    $id         = $_POST['add_id'];
    $address    = ucfirst(mysqli_real_escape_string($conn, $_POST["add_address"]));
    $mobile     = ucfirst(mysqli_real_escape_string($conn, $_POST["add_mobile"]));
    $birthday   = mysqli_real_escape_string($conn, $_POST["add_birthday"]);
