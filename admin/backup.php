					...
					<div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-title">
                                ...
                                <div class="p-3 rounded" style="background-color: #222E3C;">
                                  <small class="text-white">Make sure you already cleaned up / remove all the table in your database before uploading this file to server. Take note! This action will be use if you migrate to another hosting provider.</small>
                                </div>
                            </div>
                            </div>
                            <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <form action="backup.php" method="post" class="mt-2" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <input type="file" class="form-control" name="sql_file" id="sql_file">
                                                  <label for="sql_file"><?php echo $message; ?></label>
                                                </div>
                                                
                                               
                                                <button type="submit" class="btn btn-lg mt-2 text-white" name="import" style="background-color: #222E3C;">Import SQL file</button>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a class="btn btn-lg text-white" href="src/backup.php" id="print_report_data" style="background-color: #222E3C;">Backup My Database</a>
                                </div>
                                        ...
                                        while ($row = mysqli_fetch_assoc($showtables)) {
                                            echo '
                                                <tr class="text-center">
                                                    ...
                                                    <td><button id="drop_table" class="btn text-white" data-table_name="'.$row['Tables_in_barangaydb'].'" style="background-color: #222E3C;">Delete</button></td>
                                                </tr>';
                                        }
                                ?>
                                </tbody>
