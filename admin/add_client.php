...
<html lang="en">
    ...
    <head>
        ...
        <title>Dashboard | Add Client | MIST Appointment System</title>
        ...
        <body>
                                ...
                                <div class="col-xl-12 col-xxl-7">
                                    <div class="card flex-fill w-100">
                                        ...
                                        <div class="card-body py-3">
                                            <form id="add_walkinclient" method="post">
                                                <div class="form-group mb-3">
                                                    <input class="form-control mb-3" type="text" id="firstname" name="firstname" placeholder="Firstname">
                                                </div>

                                                <div class="form-group mb-3">
                                                    <input class="form-control mb-3" type="text" id="lastname" name="lastname" placeholder="Lastname">
                                                </div>
                                                ...
                                                <div class="form-group mb-2">
                                                    <button type="submit" class="btn btn-dark">Submit Client</button>
                                                </div>
            ...
            <script>
                $(document).ready(function() {
                    $(document).on('submit', '#add_walkinclient', function(event) {
                        event.preventDefault();
                        const client_data = $(this).serialize();
                            ...
                            $.ajax({
                                ...
                                success: function(responce) {
                                    if (responce.result == "email_used") {
                                        ...
                                        Swal.fire(
                                            'Success Message',
                                            "You have successfully entered a walk in applicant.",
                                            'success'
                                        )
                                        $("#add_walkinclient")[0].reset();
